...
SVC_NAME="actions.runner.adinath-nikam-CI_CD_FLUTTER_IOS_SELF_HOSTED_RUNER.MN0447X3XR3"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (adinath-nikam-CI_CD_FLUTTER_IOS_SELF_HOSTED_RUNER.MN0447X3XR3)"
